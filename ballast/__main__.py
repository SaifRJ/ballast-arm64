...
def main():
    ...
    bm.snapshot_manifests(engines, run_id)
    ...
    for engine in engines:
        ...
        outputs = bm.create_run_outputs(run_id, engine_name)
        ...
        for model in models:
            ...
            for corpus in corpora:
                ...
                bm.record_perplexity(outputs["perplexity"], engine_name, model, corpus, perplexity)
            ...
            for prompt in PROMPTS:
                ...
                for repeat_number in range(1, REPEATS + 1):
                    ...
                    bm.record_performance(outputs["performance"], engine_name, model, prompt, repeat_number, CONTEXT_SIZE, thread_count, GENERATED_TOKENS, metrics, ram_cpu, kv)
